...
export default function HomeHeader(){
  ...
  return(
    ...
    <h1 className="text-6xl md:text-6xl font-extralight font-['Oswald'] text-black dark:text-[#ac46a1]">Global Tech Conferences</h1>
    <button className="m-5 lg:absolute lg:right-7" onClick={handleDarkMode}>{darkMode?sunIcon:moonIcon}</button>
    </nav>
    <h2 className="text-xl mt-4 dark:text-[#a499be] text-[#4B2390] font-['Poppins'] px-3 text-center">Information about various tech conferences around the world, at your fingertips.</h2>
    </header>
    </>
  )
}