...
export default function Conferences() {
    ...
    function Modal({item}) {
        ...
        return (
            <div id='modal' className="outline-none fixed z-10 lg:left-[30%] md:left-[15%] sm:left-[15%] left-[10%] top-6 bottom-6 lg:w-1/3 md:w-2/3 sm:w-2/3 w-4/5 overflow-y-auto bg-slate-300 rounded-sm shadow-custom pb-3" tabIndex="0" onKeyDown={handleKeyDown}>
